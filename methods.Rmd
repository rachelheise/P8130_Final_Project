...
Using Cook's Distance and studentized residuals, DC could be an influential point. Cook's Distance is 0.491, close to the threshold of 0.5. The studentized residual is not greater than 2.5 for any variable. However, DFFIT is greater than 1. Could be cause for concern. Regression analysis shows it is influential, so need to delete.
